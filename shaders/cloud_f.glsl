...
void main()
    {
    float blend=clamp((vpos.z-15.0)/30.0, 0.0, 1.0);
    //float h=clamp((vpos.z-10.0)/10.0, 0.0, 1.0);

    float blend2=clamp((vpos.z-80.0)/160.0, 0.2, 1.0);
    ...
    vec4 out_color=mix(vec4(fog.rgb, 1.0),vec4(skyColor.rgb, 1.0),blend2) +stars;
